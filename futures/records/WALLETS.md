...
seed phrase or private key (lock-record security law). FUT FLOAT retired 2026-08-12 (2% float abolished — flat 10% all-in). The desk runs on a
...
- The treasury address becomes InstarLock build-time constants at deploy.
